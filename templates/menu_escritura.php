...
<ul>
   <li class='active'><a href="index.php"><span>Inicio</span></a></li>
    <li class='has-sub'><a href="index.php?pagina=escritura_academica_ensayo"><span>Ensayo</span></a>
     <!-- <ul>
   ...
   <li><a href="index.php?pagina=escritura_academica_tesis"><span>Tesis</span></a>
      
   </li>

 <li class='last'><a href="index.php?pagina=escritura_academica_normas_APA" onClick="ga('send', 'event', 'enlace', 'click', 'registro_curso', 1 );">Normas APA</a> </li>
